    ...
    <div className="bg-slate-900/50 py-20">
      <Section id="features">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {/* Offline Card */}
          <div className="bg-surface border border-white/5 rounded-3xl p-8 hover:border-orange-500/30 transition-all duration-300">
            ...
            <div className="space-y-4">
              {offlineFeatures.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-orange-500/20 transition-colors group"
                  >
          ...
          {/* Online Card */}
          <div className="bg-surface border border-white/5 rounded-3xl p-8 hover:border-blue-500/30 transition-all duration-300">
            <div className="flex items-center gap-4 mb-8">
            ...
            <div className="space-y-4">
              {onlineFeatures.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-blue-500/20 transition-colors group"
                  >
        ...
        {/* Comparison Table */}
        <div className="bg-surface border border-white/5 rounded-3xl p-8 overflow-hidden">
